...
namespace afw_project.Model.Validation.Objects
{
    class CategoryName : ValidatableObject
    {
        ...
        protected override void AddValidations()
        {
            ...
            validations.Add(new HasRightFormat { Message = "Invalid format.", Format = @"^[\p{L}\p{M}\d\s(),\.\-'/]+$" });
            validations.Add(new HasRightEnding { Message = "Invalid ending characters", End = @"[^\s\-/,(]$" });
